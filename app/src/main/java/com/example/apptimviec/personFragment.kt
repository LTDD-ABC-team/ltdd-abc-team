...
class personFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val user = db.readUser(pre!!.getInt("user_id",1))
        view.findViewById<TextView>(R.id.textViewUserName_person2).text = user.username
        view.findViewById<TextView>(R.id.textViewEmail_person2).text = user.email
